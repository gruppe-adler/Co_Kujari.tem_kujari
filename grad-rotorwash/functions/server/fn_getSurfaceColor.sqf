...
switch (surfaceType _point) do {
    ...
    case "#tem_kujari_tumma_hiekka_Surface": { _colorR = 0.3; _colorG = 0.25; _colorB = 0.2; _alpha = 1; };
    case "#tem_kujari_keltainen_hiekka_Surface": { _colorR = 0.3; _colorG = 0.27; _colorB = 0.26; _alpha = 1; };
    case "#tem_kujari_vaalea_hiekka_Surface": { _colorR = 0.3; _colorG = 0.27; _colorB = 0.26; _alpha = 1; };
