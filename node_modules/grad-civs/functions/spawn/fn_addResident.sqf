...
if (isNil "_house") exitWith {DEBUG("could not find spawn position for resident this time (nil)")};
if (isNull _house) exitWith {DEBUG("could not find spawn position for resident this time (null)")};
