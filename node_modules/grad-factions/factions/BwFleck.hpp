...
class BWFleck {
	class AllUnits {
		...
		primaryWeaponOptics = "rhsusf_acc_EOTECH";
		...
		radio = "tfar_anprc152";
		nvgoggles = NVITEM;
        goggles[]= {"G_Bandanna_khk","G_Bandanna_oli","G_Bandanna_blk","rhsusf_shemagh2_grn","rhsusf_shemagh2_od","rhsusf_shemagh2_tan","rhsusf_shemagh2_white","G_Balaclava_TI_blk_F","rhs_scarf"};
    };
    class Type {
        //Rifleman
        class Soldier_F {
